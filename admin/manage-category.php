  ...
  <div class="wrapper">
    ...
    <br/><br/>
     ...
     //query to get data from database
      ...
      //create serial no. variable and siign value 1
      $sn=1;
      //check whether we have data in the db
      if($count>0)
      {
        ...
        while($row=mysqli_fetch_assoc($res))
        {
          ...
          <tr>
            ...
            <td><a class="btn-secondary"href="<?php echo SITEURL; ?>admin/update-category.php?id=<?php echo $id; ?>">Update Category</a>
